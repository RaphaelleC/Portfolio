          ...
          <div className="col-8">  
            <div className="row">
              <div className="row">
                ...
                <div className="col-2">
                  <i className="fa fa-css3-alt fa-3x"></i>
                  <p>CSS3</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-js fa-3x"></i>
                  <p>JavaScript</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-sass fa-3x"></i>
                  <p>Sass</p>
                </div>
              </div>
              <div className="row">
                <div className="col-2"></div>
                <div className="col-2">
                  <i className="devicon-bulma-plain icon-bigger-size"></i>
                  <p>Bulma</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-react fa-3x"></i>
                  <p>React</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-node-js fa-3x"></i>
                  <p>Node.js</p>
                </div>
                <div className="col-2">
                  <i className="devicon-mongodb-plain icon-bigger-size"></i>
                  <p>MongoDB</p>
                </div>
              </div>
              <div className="row">
                <div className="col-2"></div>
                <div className="col-2">
                  <i className="devicon-express-original icon-bigger-size"></i>
                  <p>Express</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-python fa-3x"></i>
                  <p>Python</p>
                </div>
                <div className="col-2">
                  <i className="devicon-django-plain icon-bigger-size"></i>
                  <p>Django</p>
                </div>
                <div className="col-2">
                  <i className="devicon-postgresql-plain icon-bigger-size"></i>
                  <p>PostgreSQL</p>
                </div>
              </div>
              <div className="row">
                <div className="col-2"></div>
                <div className="col-2">
                  <i className="fa fa-bootstrap fa-3x"></i>
                  <p>Bootstrap</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-git-alt fa-3x"></i>
                  <p>Git</p>
                </div>
                <div className="col-2">
                ...
                <div className="col-2">
                  <i className="devicon-heroku-original icon-bigger-size"></i>
                  <p>Heroku</p>
                </div>
              </div>
              <div className="row">
                ...
                <div className="col-2"></div>
                <div className="col-2">
                  <i className="devicon-vscode-plain icon-bigger-size"></i>
                  <p>VSCode</p>
                </div>
                <div className="col-2">
                  <i className="fa fa-slack fa-3x"></i>
                  <p>Slack</p>
                </div>
              </div>
            </div>
